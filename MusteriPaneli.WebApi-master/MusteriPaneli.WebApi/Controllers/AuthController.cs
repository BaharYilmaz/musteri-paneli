...
using MusteriPaneli.WebApi.Dtos;
...
namespace MusteriPaneli.WebApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            if (await _authRepository.KullaniciKontrol(userForRegisterDto.UserName))
            {
            ...
            var userToCreate = new Yonetici
            {
                KullaniciAdi = userForRegisterDto.UserName
            };
        ...
        public async Task<ActionResult> GirisYap([FromBody] UserForLoginDto userForLoginDto)
        {
            ...
            var tokenDescription = new SecurityTokenDescriptor()
            {
                Subject = new ClaimsIdentity(new Claim[]
                {
                    ...
                    new Claim (ClaimTypes.NameIdentifier,user.YoneticiId.ToString()),
